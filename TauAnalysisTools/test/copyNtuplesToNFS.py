...
inputPath = "/pnfs/desy.de/cms/tier2/store/user/ohlushch/TauIDMVATraining2016/Summer16_25ns_V1_allPhotonsCut_allIsoCones/"

# generic path to NFS where we want to copy ntuples to
outputPath = "/nfs/dust/cms/user/glusheno/TauIDMVATraining2016/Summer16_25ns_V1_allPhotonsCut_allIsoCones/ntuples/"
